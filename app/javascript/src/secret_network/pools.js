$(document).ready(async function(){
  if($("#secret-network-pools").length) {
    ...
    this.calculateGas = function(gas) {
      return String(gas * document.secretNetwork.gasAndDelayFactor)
    }
