$(document).ready(function(){
  if($("#secret-network-address-alias").length) {
    document.addressAliasContractAddress = 'secret19993tt7657ljrzt27dh8wm7kxfedgezyuva96w'
    document.addressAliasContractDataHash = 'D3194D7CEBE185E50C4D3CD3CF40827F58DFC48971EE330087CEFA8395FA0B6E'
      ...
      try {
        ...
        if (document.secretNetwork.walletAddress) {
          ...
          let params = {
            ...
            contract: document.addressAliasContractAddress,
            codeHash: document.addressAliasContractDataHash, // optional but way faster
            msg: { destroy: { alias: alias } },
            sentFunds: [], // optional
          }
          await document.secretNetwork.executeContract(params, document.gasDelete())
          $("#result-value").html('')
    ...
    document.aliasCreateForm.onsubmit = async (e) => {
      ...
      try {
        ...
        if (document.secretNetwork.walletAddress) {
          ...
          let handleMsg = { send: { amount: '1000000', recipient: document.addressAliasContractAddress, msg: Buffer.from(JSON.stringify({ create: { alias: alias, avatar_url: avatarUrl } })).toString('base64') } }
          let params = {
            sender: document.secretNetwork.walletAddress,
          ...
          let response = await document.secretNetwork.executeContract(params, document.gasCreate())
    ...
    document.aliasSearchForm.onsubmit = async (e) => {
      ...
      try {
        ...
        let queryParams = {
          address: document.addressAliasContractAddress,
          codeHash: document.addressAliasContractDataHash,
